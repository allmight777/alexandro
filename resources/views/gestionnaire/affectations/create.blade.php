...
@section('content')
    ...
    <div class="container mt-5">
        ...
        @endif -->
        <!-- ----------------------------------Style pour personnaliser l'erreur-------------------------------------- -->
        @if(session('error'))
            <div class="alert alert-danger d-flex align-items-center" role="alert" style="font-weight: 600; font-size: 1.1rem;">
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M6.938 4h10.124a2 2 0 011.992 2.166l-.93 9a2 2 0 01-1.992 1.834H8.868a2 2 0 01-1.992-1.834l-.93-9A2 2 0 016.938 4z" />
                </svg>
                {{ session('error') }}
            </div>
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('gestionnaire.affectation') }}" method="POST">
                    @csrf
