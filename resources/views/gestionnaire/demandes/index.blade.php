                ...
                @forelse ($demandes as $demande)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            {{-- Bouton Rejeter --}}
                            <form action="{{ route('gestionnaire.demandes.refuser', $demande->id) }}" method="POST" class="d-inline">
                                @csrf @method('PUT')
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{route("gestionnaire.demandes.valider",$demande->id)}}" method="POST" class="me-auto">
                                        @csrf @method('PUT')
                                    ...
                                    <form action="{{route("gestionnaire.demandes.attente",$demande->id)}}" method="POST">
                                        @csrf @method('PUT')
