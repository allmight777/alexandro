...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <!-- Nouvelle section: Équipements en panne -->
        <li class="nav-item">
            <a class="nav-link" href="equipment-out-of-service.html">
                <i class="mdi mdi-alert-circle-outline menu-icon"></i>
                <span class="menu-title">Équipements en panne</span>
            </a>
        </li>
        
        <!-- Nouvelle section: Équipements perdus -->
        <li class="nav-item">
            <a class="nav-link" href="equipment-lost.html">
                <i class="mdi mdi-emoticon-sad-outline menu-icon"></i>
                <span class="menu-title">Équipements perdus</span>
            </a>
        </li>
        
        <!-- Nouvelle section: Collaborateurs externes -->
        <li class="nav-item">
        ...
        <li class="nav-item">
            <form action="{{route('logout')}}" method="post">
                @method("post")
                @csrf
                <button type="submit" class="btn btn-danger mybtn">Déconnexion</button>
            </form>
        </li>
    </ul>
</nav>
