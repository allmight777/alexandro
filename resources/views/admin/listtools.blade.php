        ...
        <div class="search-field d-none d-md-block">
          <form class="d-flex align-items-center h-100" action="#">
            <div class="input-group">
              ...
              <input type="text" class="form-control bg-transparent border-0" placeholder="Rechercher un équipement..." id="navbar-search">
            </div>
          </form>
        </div>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" data-toggle="collapse" href="#equipment-management" aria-expanded="true" aria-controls="equipment-management">
            ...
            <div class="collapse show" id="equipment-management">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item active"> <a class="nav-link" href="equipment-list.html">Inventaire</a></li>
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        @foreach ( $equipements as $equip )
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                <img src="/{{$equip->image_path}}" alt="Laptop" class="equipment-img">
                                <span>{{ $equip->nom }}</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <a href="{{route("putToolpage",$equip->id)}}"><i class="mdi mdi-pencil edit-icon action-icon" title="Modifier"></i></a>
                                <a href="{{ route("DeleteTool",$equip->id) }}"><i class="mdi mdi-delete delete-icon action-icon" title="Supprimer"></i></a> 
                            </td>
                            </tr>
                        @endforeach
                  ...
                  <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="text-muted">Affichage de 1 à 5 sur 25 équipements</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.edit-icon').forEach(icon => {
        icon.addEventListener('click', function() {
          ...
          console.log('Modifier équipement:', this.closest('tr').querySelector('td').textContent.trim());
        });
      });
