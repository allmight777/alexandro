            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link sidebar-dropdown-toggle" href="#user-management"
                    ...
                    <li class="nav-item">
                        <a class="nav-link sidebar-dropdown-toggle" href="#equipment-management"
                            data-target="#equipment-management">
                    ...
                    <li class="nav-item">
                       <form action="{{route('logout')}}" method="post">
                              @method("post")
                              @csrf
                              <button type="submit"><a href="" class="btn btn-danger mybtn">Déconnexion</a></button>
                       </form>
                    </li>
                </ul>
            </nav>
                                ...
                                <div class="page-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Modifiez les informations de l'utilisateur
                                                ci-dessous</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form method="POST" action="{{ route('putuser', $user->id) }}">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="firstName"
                                                        class="form-label required-label">Prénom</label>
                                                    <input type="text" class="form-control" id="firstName"
                                                        placeholder="Entrez le prénom" required name="prenom"
                                                        value="{{ $user->prenom }}">
                                                    @error('prenom')
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="email"
                                                        class="form-label required-label">Email</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="role"
                                                        class="form-label required-label">Rôle</label>
                                                    <select class="form-select" id="role" required
                                                        ...
                                                        <option value="gestionnaire"
                                                            {{ $user->role == 'gestionnaire' ? 'selected' : '' }}>
                                                             gestionnaire</option>
                                                        <option value="employée"
                                                            {{ $user->role == 'employée' ? 'selected' : '' }}>employée
                                                        </option>
                                                    </select>
                                                    @error('role')
                                                        <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="poste"
                                                        class="form-label required-label">Poste</label>
                                                    <select class="form-select" id="poste" required
                                                        name="poste">
                                                        <option value="developpeur"
                                                            {{ $user->poste == 'developpeur' ? 'selected' : '' }}>
                                                            developpeur</option>
                                                        <option value="designer"
                                                            {{ $user->poste == 'designer' ? 'selected' : '' }}>designer
                                                        </option>
                                                        <option value="chef_projet"
                                                            {{ $user->poste == 'chef_projet' ? 'selected' : '' }}>
                                                            chef_projet
                                                        </option>
                                                        <option value="support"
                                                            {{ $user->poste == 'support' ? 'selected' : '' }}>support
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="service"
                                                        class="form-label required-label">Service</label>
                                                    <select class="form-select" id="service" required
                                                        ...
                                                        <option value="marketing"
                                                            {{ $user->service == 'marketing' ? 'selected' : '' }}>
                                                            marketing</option>
                                                        <option value="commercial"
                                                            {{ $user->service == 'commercial' ? 'selected' : '' }}>
                                                            commercial</option>
                                                        <option value="production"
                                                            {{ $user->service == 'production' ? 'selected' : '' }}>
                                                            production</option>
                                                        <option value="rh"
                                                            {{ $user->service == 'rh' ? 'selected' : '' }}>
                                                            rh</option>
                                                    </select>
                                                    @error('service')
                                                        <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="password" class="form-label required-label">Mot de
                                                        passe </label>
